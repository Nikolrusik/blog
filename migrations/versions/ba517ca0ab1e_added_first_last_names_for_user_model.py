"""Added first, last names for user model

Revision ID: ba517ca0ab1e
Revises: a775fadbda33
Create Date: 2023-02-04 01:07:24.082699
...
revision = 'ba517ca0ab1e'
down_revision = 'a775fadbda33'
branch_labels = None
depends_on = None
